...
public class SDMBestiaryClient extends SDMBestiaryCommon {
    ...
    @Override
    public void preInit() {
        ClientRegistry.registerKeyBinding(KEY_SHOP = new KeyMapping("key.sdm.bestiary",KeyConflictContext.UNIVERSAL, KeyModifier.NONE, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_UNKNOWN, "key.category.bestiary"));
